...
public class wanhu_crypt implements CryptInterface {
    @Override
    ...
    public static String whDecryptCon(String passwd) throws Exception {
        String str2 = passwd;
        try {
            String res = AESEncryptor.decrypt("whir2014", str2);
            return res;
        } catch (Exception e) {
            return null;
        }
    ...
    public static String whEncryptCon(String text){
        try {
            return AESEncryptor.encrypt("whir2014", text);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
